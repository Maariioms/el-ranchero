...
import { TriangleAlert, ArrowRight, ShoppingBag, User, Menu, Briefcase, DollarSign,  ShieldCheck, Package, X, Truck, Instagram, Facebook, Twitter, ShieldAlert, Scale, FileCheck, Award, Leaf, CheckCircle2, Flame, Hammer, Star, MapPin, Thermometer, Clock, BookOpen, AlertTriangle, Phone, ShoppingCart, ChefHat } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg text-[#FFFFFF] selection:bg-accent selection:text-bg font-sans">
      ...
      <footer className="bg-[#050505] border-t border-accent/20 pt-16 pb-8 text-sm">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 border-b border-white/10 pb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/tradicion" className="text-gray-400 hover:text-accent transition-colors">Nuestra Historia</a></li>
                <li><a href="/interest" className="text-gray-400 hover:text-accent transition-colors">Sé Distribuidor</a></li>
              </ul>
            </div>
